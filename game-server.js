// ==================== GAME-SERVER.JS ====================
// VERSION: 3.0.8 - OPTIMIZED NO TTL
...
export class GameServer {
  ...
  _startMainInterval() {
    ...
    // INTERVAL LEBIH JARANG - 30 DETIK
  ...
  _startDiceFast() {
    try {
      ...
      // TIMER DENGAN NOTIFIKASI DI 15, 10, 5
      let timeLeft = 20;
  ...
  _broadcastToRoom(room, message) {
    try {
      ...
      // THROTTLE UNTUK NOTIFIKASI YANG SERING
