...
// VERSION: 15.0.0 - NON-HIBERNATION + FULL D1 PERSISTENCE
// ============================================================
...
class DataManager {
  ...
  async deleteActiveGames() {
    await this._ensureCacheInitialized();
    this._cache.activeGames = {};
    await this._save('activeGames', this._cache.activeGames);
    return true;
  }
...
// ============================================================
// GAME SERVER — NON-HIBERNATION + FULL D1
// ============================================================
...
export class GameServer {
  constructor(state, env) {
    try {
      ...
      // === IN-MEMORY (NON-HIBERNASI) ===
      this.activeGames = new Map();
      this.wsMap = new Map();
      this.wsClients = new Map();
      this.clientRooms = new Map();
      this.userConnections = new Map();
      this._wsMeta = new Map();  // ✅ Ganti serializeAttachment
      this._eventQueue = [];
  ...
  _setWsMeta(ws, meta) {
    try {
      ...
      this._wsMeta.set(wsId, { ...meta, updatedAt: Date.now() });
      return true;
    } catch(e) { return false; }
  }
  ...
  async _restoreAllState() {
    ...
    this._restorePromise = (async () => {
      try {
        ...
        // ✅ 2. LOAD SEMUA DATA DARI D1
        await this.dataManager.loadAllData();
        
        // ✅ 3. RESTORE ALARM DARI D1
        await this.alarmScheduler.restoreAlarms();
        
        // ✅ 4. JADWAL ULANG ALARM
        await this.alarmScheduler.scheduleAlarms();
        
        // ✅ 5. CEK WEEKLY RESET
        await this._checkAndForceResetIfMondayUTC();
        
        // ✅ 6. RESET WEBSOCKET (NON-HIBERNASI = KOSONG)
        this._resetWebSocketsInMemory();
        
        // ✅ 7. LOAD ACTIVE GAMES DARI D1
  ...
  // ============================================================
  // RESET WEBSOCKET IN-MEMORY (NON-HIBERNASI)
  // ============================================================
  
  _resetWebSocketsInMemory() {
    try {
      this.wsMap.clear();
  ...
  async _restoreActiveGames() {
    try {
      ...
      if (!games || Object.keys(games).length === 0) return;
  ...
  async fetch(req) {
    try {
      ...
      if (url.pathname === "/game/ws") {
        ...
        // ✅ NON-HIBERNASI: TIDAK PAKAI ctx.acceptWebSocket
        // Cukup set properti in-memory
        server._wsId = wsId;
        ...
        // ✅ NON-HIBERNASI: EVENT LISTENER MANUAL
        try {
          ...
          server.addEventListener('close', (event) => {
            try {
              this.webSocketClose(server, event.code || 1000, event.reason || '', event.wasClean || false).catch(() => {});
            } catch(e) {}
          });
          server.addEventListener('error', () => {
            try {
              this.webSocketClose(server, 1006, 'error', false).catch(() => {});
            } catch(e) {}
          });
        } catch(e) {}
  ...
  // ============================================================
  // WEBSOCKET HANDLERS — NON-HIBERNASI
  // ============================================================
  
  async webSocketMessage(ws, message) {
    if (!ws || ws._closing || this.closing || this.isDestroyed) return;
    
    // ✅ BACA DARI IN-MEMORY META (bukan deserializeAttachment)
  ...
  // ============================================================
  // ENSURE CLIENT IN ROOM — NON-HIBERNASI
  // ============================================================
  ...
  _ensureClientInRoom(ws, room, username = null) {
    try {
      ...
      // ✅ GANTI serializeAttachment → in-memory meta
      this._setWsMeta(ws, {
  ...
  _getClientRoom(ws) {
    try {
      ...
      if (wsId) {
        ...
        if (meta && meta.room) return meta.room;
      }
  ...
  // ============================================================
  // GET CLIENT USERNAME — NON-HIBERNASI
  // ============================================================
  ...
  // ============================================================
  // SYNC ROOM CLIENTS — NON-HIBERNASI
  // ============================================================
  ...
  _incrementGameVersion(game) {
    if (game) game._version = (game._version || 0) + 1;
  }
