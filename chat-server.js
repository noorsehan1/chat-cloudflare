...
export class ChatServer {
  constructor(state, env) {
    ...
    // Scheduled update number & cleanup
    this._scheduleTasks();
  }
  ...
  _cleanupConnections() {
    ...
    try {
      ...
      // Hapus koneksi mati dari userConnections
      ...
      // Hapus koneksi mati dari roomClients
      for (const [room, clients] of this.roomClients) {
