// ==================== CHAT-SERVER.JS - SIMPLE VERSION ====================
// VERSION: 6.0.0 - SIMPLE PURE WORKER
...
export class ChatServer {
  constructor(options) {
    ...
    // WebSocket stores - ALL IN MEMORY
    this.wsSet = new Set();
    ...
    try {
      ...
      switch(evt) {
        ...
        case "getCurrentNumber":
          try { this.safeSend(ws, ["currentNumber", 1]); } catch(e) {}
          break;
