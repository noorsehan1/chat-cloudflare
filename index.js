  ...
  safeSend(ws, arr) {
    try {
      if (ws.readyState === 1) {
        ...
        // CONNECTING — coba lagi setelah 300ms
        setTimeout(() => {
          if (ws.readyState === 1) {
        ...
        // Jika CLOSING atau CLOSED, biarkan event close/error yang cleanup
      }
    } catch (e) {
      // Jangan langsung cleanup supaya koneksi tidak terputus mendadak
    }
  }
